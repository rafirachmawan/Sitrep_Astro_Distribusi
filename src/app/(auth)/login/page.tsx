...
/**
 * Demo accounts (mock). Di produksi, ganti dengan call API.
 * key = username (lowercase, tanpa spasi)
 */
...
> = {
  ...
  dewi: { password: "super456", role: "superadmin", displayName: "Dewi" },
...
export default function LoginPage() {
  ...
  return (
    <div className="min-h-screen bg-slate-100 text-slate-800">
      {/* Header: samakan dengan dashboard */}
          ...
          <section className="order-2 lg:order-1">
            <div className="rounded-2xl border bg-white shadow-sm p-6">
              ...
              <p className="mt-1 text-sm text-slate-600">
                Akunmu memiliki role yang sudah dipatenkan. Cukup masukkan
                <span className="font-medium"> Nama</span> dan
                <span className="font-medium"> Password</span>. Setelah
                berhasil, header dashboard otomatis menampilkan <b>Nama</b>,{" "}
                <b>Role</b>, dan <b>Depo TULUNGAGUNG</b>.
              </p>
